...
export default function Footer() {
  ...
  const whatsapp = t("footer.whatsapp");
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16 lg:py-20">
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <a href="#home" aria-label="Wtraders — go to top">
              <img
          ...
          <div>
            ...
            <h4 className="mt-8 text-sm font-semibold uppercase tracking-wider text-white mb-4">
              {t("footer.legalLinksTitle")}
            </h4>
            <ul className="space-y-3">
              {legalLinks.map((link) => (
                <li key={link.label}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                ...
                >
                  <Mail size={14} className="text-fiper" />
              ...
              <li>
                <a
                  ...
                  className="group inline-flex items-center gap-2 text-sm text-zinc-500 transition-colors duration-200 hover:text-white"
                >
                  <MessageCircle size={14} className="text-fiper" />
        ...
        <div className="mt-14 pt-8 border-t border-white/5">
          <p className="mx-auto max-w-prose text-center text-[11px] leading-relaxed text-zinc-600 italic">
