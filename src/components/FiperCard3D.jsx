      ...
      >
        <div
          ...
          style={{
            ...
            filter: "drop-shadow(0 25px 60px rgba(0,0,0,0.7)) drop-shadow(0 0 40px rgba(220,38,38,0.18))",
          }}
        >
          <img
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: "linear-gradient(135deg, #DC2626 0%, #991B1B 40%, #7F1D1D 70%, #450A0A 100%)",
          transform: "rotateY(-15deg) rotateX(10deg)",
          transformStyle: "preserve-3d",
          boxShadow: "0 30px 80px -15px rgba(220,38,38,0.4), 0 0 60px -10px rgba(220,38,38,0.3)",
        }}
      >
        <div
        ...
        <div className="relative h-full p-6 flex flex-col justify-between">
          <div className="flex items-start justify-between">
            <img src="/Fiper_Logo_white2.png" alt="Fiper" className="h-16 w-auto object-contain" />
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-end justify-between">
              ...
              <p className="font-bold text-xl text-white/80 tracking-[0.08em]">FIPER</p>
            </div>
          </div>
        </div>
      </div>
